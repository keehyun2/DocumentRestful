package com.socketmessage.doc.config;
...
public class DatabaseConfig {
	...
	public SqlSessionFactory sqlSessionFactory(DataSource dataSource) throws Exception{
		...
		sqlSessionFactory.setTypeHandlersPackage("com.socketmessage.doc.config");
	...
	public MapperScannerConfigurer mapperScannerConfigurer(){
		...
		configurer.setBasePackage("com.socketmessage.doc.mappers");
		return configurer;
	}
