DROP TABLE DOC_USER CASCADE CONSTRAINTS;
...
COMMENT ON COLUMN DOC_USER.USEDOC_USERE IS '사용자명(ID or email)' ;
...
DROP TABLE DOC_SUMMARY CASCADE CONSTRAINTS;
...
DROP TABLE DOC_DETAIL CASCADE CONSTRAINTS;
